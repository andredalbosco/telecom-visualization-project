@echo off
REM Runner for sketch_2_2_heatmap.ipynb -- portable execute + debug + control-visibility patch.
setlocal enabledelayedexpansion
cd /d "%~dp0"
set "NB=sketch_2_2_heatmap.ipynb"
set "OUT=sketch_2_2_heatmap_out.ipynb"
...
echo.
echo [OK] sketch_2_2_heatmap ran cleanly. PNG: sketch_2_2_heatmap.png
endlocal
exit /b 0
