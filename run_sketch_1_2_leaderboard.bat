@echo off
REM Runner for sketch_1_2_leaderboard.ipynb -- portable execute + debug + control-visibility patch.
setlocal enabledelayedexpansion
cd /d "%~dp0"
set "NB=sketch_1_2_leaderboard.ipynb"
set "OUT=sketch_1_2_leaderboard_out.ipynb"
...
echo.
echo [OK] sketch_1_2_leaderboard ran cleanly. PNG: sketch_1_2_leaderboard.png
endlocal
exit /b 0
