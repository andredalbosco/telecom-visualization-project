#!/usr/bin/env bash
# Runner for sketch_1_5_streamgraph.ipynb -- portable execute + debug + control-visibility patch.
set -euo pipefail
cd "$(dirname "$0")"
PY="${PYTHON:-python3}"
NB="sketch_1_5_streamgraph.ipynb"
OUT="sketch_1_5_streamgraph_out.ipynb"
