@echo off
REM Runner for sketch_2_6_small_multiples.ipynb -- portable execute + debug + control-visibility patch.
setlocal enabledelayedexpansion
cd /d "%~dp0"
set "NB=sketch_2_6_small_multiples.ipynb"
set "OUT=sketch_2_6_small_multiples_out.ipynb"
...
echo.
echo [OK] sketch_2_6_small_multiples ran cleanly. PNG: sketch_2_6_small_multiples.png
endlocal
exit /b 0
