#!/usr/bin/env bash
# Runner for sketch_2_6_small_multiples.ipynb -- portable execute + debug + control-visibility patch.
set -euo pipefail
cd "$(dirname "$0")"
PY="${PYTHON:-python3}"
NB="sketch_2_6_small_multiples.ipynb"
OUT="sketch_2_6_small_multiples_out.ipynb"
