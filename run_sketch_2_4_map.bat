@echo off
REM Runner for sketch_2_4_map.ipynb -- portable execute + debug + control-visibility patch.
setlocal enabledelayedexpansion
cd /d "%~dp0"
set "NB=sketch_2_4_map.ipynb"
set "OUT=sketch_2_4_map_out.ipynb"
...
echo.
echo [OK] sketch_2_4_map ran cleanly. PNG: sketch_2_4_map.png
endlocal
exit /b 0
