@echo off
REM Runner for sketch_3_5_scatter.ipynb -- portable execute + debug + control-visibility patch.
setlocal enabledelayedexpansion
cd /d "%~dp0"
set "NB=sketch_3_5_scatter.ipynb"
set "OUT=sketch_3_5_scatter_out.ipynb"
...
echo.
echo [OK] sketch_3_5_scatter ran cleanly. PNG: sketch_3_5_scatter.png
endlocal
exit /b 0
