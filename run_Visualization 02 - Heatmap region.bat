@echo off
REM Runner for "Visualization 02 - Heatmap region.ipynb" -- portable execute + debug + control-visibility patch.
setlocal enabledelayedexpansion
cd /d "%~dp0"
set "NB=Visualization 02 - Heatmap region.ipynb"
set "OUT=Visualization 02 - Heatmap region_out.ipynb"
...
echo.
echo [OK] Visualization 02 - Heatmap region ran cleanly. PNG: Visualization 02 - Heatmap region.png
endlocal
exit /b 0
