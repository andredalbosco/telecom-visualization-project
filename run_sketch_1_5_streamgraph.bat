@echo off
REM Runner for sketch_1_5_streamgraph.ipynb -- portable execute + debug + control-visibility patch.
setlocal enabledelayedexpansion
cd /d "%~dp0"
set "NB=sketch_1_5_streamgraph.ipynb"
set "OUT=sketch_1_5_streamgraph_out.ipynb"
...
echo.
echo [OK] sketch_1_5_streamgraph ran cleanly. PNG: sketch_1_5_streamgraph.png
endlocal
exit /b 0
