@echo off
REM Runner for "Visualization 01 - Streamgraph.ipynb" -- portable execute + debug + control-visibility patch.
setlocal enabledelayedexpansion
cd /d "%~dp0"
set "NB=Visualization 01 - Streamgraph.ipynb"
set "OUT=Visualization 01 - Streamgraph_out.ipynb"
