@echo off
REM Runner for sketch_3_2_violin.ipynb -- portable execute + debug + control-visibility patch.
setlocal enabledelayedexpansion
cd /d "%~dp0"
set "NB=sketch_3_2_violin.ipynb"
set "OUT=sketch_3_2_violin_out.ipynb"
