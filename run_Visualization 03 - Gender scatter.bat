@echo off
REM Runner for "Visualization 03 - Gender scatter.ipynb" -- portable execute + debug + control-visibility patch.
setlocal enabledelayedexpansion
cd /d "%~dp0"
set "NB=Visualization 03 - Gender scatter.ipynb"
set "OUT=Visualization 03 - Gender scatter_out.ipynb"
...
echo.
echo [OK] Visualization 03 - Gender scatter ran cleanly. PNG: Visualization 03 - Gender scatter.png
endlocal
exit /b 0
