@echo off
REM Runner for sketch_3_3_positional.ipynb -- portable execute + debug + control-visibility patch.
setlocal enabledelayedexpansion
cd /d "%~dp0"
set "NB=sketch_3_3_positional.ipynb"
set "OUT=sketch_3_3_positional_out.ipynb"
...
echo.
echo [OK] sketch_3_3_positional ran cleanly. PNG: sketch_3_3_positional.png
endlocal
exit /b 0
