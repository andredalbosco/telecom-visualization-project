#!/usr/bin/env bash
# Runner for sketch_3_3_positional.ipynb -- portable execute + debug + control-visibility patch.
set -euo pipefail
cd "$(dirname "$0")"
PY="${PYTHON:-python3}"
NB="sketch_3_3_positional.ipynb"
OUT="sketch_3_3_positional_out.ipynb"
